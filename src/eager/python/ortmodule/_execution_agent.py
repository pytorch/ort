...
from .onnxruntime_inference_collection import IOBinding, OrtValue, InferenceSession
from torch_ort import TrainingAgent as C_TrainingAgent
...
class InferenceAgent(object):
    ...
    def create_inference_agent(self, path_or_bytes, session_options, providers, provider_options):
        self._inference_session = InferenceSession(path_or_bytes, session_options,
